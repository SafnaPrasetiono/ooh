...
<head>
    <title>verifikasi@ooh.co.id</title>
</head>
...
<body>
    ...
    <div
        ...
        <div
            style="background-color:#0d6efd;box-sizing:border-box;width:100%;padding-right:15px;padding-left:15px;padding-top:.5rem!important;padding-bottom:.5rem!important">
            ...
            <div
                ...
                <div style="box-sizing:border-box;display:block!important">
                    ...
                    <p style="box-sizing:border-box;margin-top:0;margin-bottom:1rem;display:block!important">
                        Terima kasih telah mendaftar di <span class="il">OOH</span>. Berikut adalah
                ...
                <div
                    ...
                    <a href="https://ooh.co.id/register/validasi/key={{ $details['key'] }}"
                        style="box-sizing:border-box;color:white;text-decoration:none!important;background-color:#0d6efd;padding-top:16px;padding-bottom:16px;padding-left:24px;padding-right:24px;font-size:20px;border-radius:4px"
                        target="_blank">Aktivasi Akun</a>
                </div>
                <div style="box-sizing:border-box;display:block!important;margin-bottom:1.5rem!important">
                    <div
                        style="border:1px solid #0d6efd;box-sizing:border-box;display:flex;min-width:0;word-wrap:break-word;background-color:#fff;background-clip:border-box;border-radius:.25rem;margin-bottom:1rem!important">
                        <div style="box-sizing:border-box;min-height:1px;padding:1.25rem;color:#343a40!important">
                            ...
                            <a href="https://ooh.co.id/register/validasi/key={{ $details['key'] }}"
                                ...
                                target="_blank">
                                https://ooh.co.id/register/validasi/key={{ $details['key'] }}
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div style="box-sizing:border-box;display:block!important">
                ...
                <div
                    ...
                    <small style="box-sizing:border-box;font-size:80%;font-weight:400">Anda menerima pesan ini sebagai
                        aktivasi pendaftaran <span style="color: #fff">ooh.co.id.</span></small>
                </div>
                <div
                    ...
                    <small style="box-sizing:border-box;font-size:80%;font-weight:400">
                        © 2022 <span style="color: #fff;">ooh.co.id</span>, jakarta.
                    </small>
                </div>
            </div>
