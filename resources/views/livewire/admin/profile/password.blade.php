<div>
    <div class="container-fluid">
        <div class="d-flex align-items-center bg-custom rounded-3 border shadow-sm p-3">
            ...
            <div class="ms-0 ms-md-4">
                ...
                <button wire:click='show' type="button" class="btn btn-custom-1 rounded-0">Set Password</button>
            </div>
        </div>
    </div>
